          ...
          <div className='bg-rellenos border border-bordes w-full sm:max-w-lg md:max-w-xl lg:max-w-4xl rounded text-blanco p-4 flex flex-col gap-4 md:flex-row'>
            ...
            <div className='md:w-3/4'>
              ...
              <p className='relative w-full whitespace-normal line-clamp-4'>
                Hello, my name is Ditya Athallah. Frontend Developer based in
                Indonesia who specializes in javascript and react.js. Since
                2018, I&#39;ve had a strong interest in software engineering and
                related fields, particularly web development. I&#39;ve been
                studying web development for over four years.
              </p>
